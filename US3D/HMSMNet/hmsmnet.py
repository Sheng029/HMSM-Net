...
class HMSMNet:
    ...
    def build_model(self):
        ...
        cost0 = CostConcatenation(max_disp=self.max_disp // 4)
        cost1 = CostConcatenation(max_disp=self.max_disp // 8)
        cost2 = CostConcatenation(max_disp=self.max_disp // 16)
        ...
        estimator2 = Estimation(max_disp=self.max_disp // 16)
        ...
        estimator1 = Estimation(max_disp=self.max_disp // 8)
        ...
        estimator0 = Estimation(max_disp=self.max_disp // 4)
